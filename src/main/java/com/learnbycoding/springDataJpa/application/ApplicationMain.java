package com.learnbycoding.springDataJpa.application;
...
import com.learnbycoding.springDataJpa.config.AppConfig;
import com.learnbycoding.springDataJpa.model.Student;
import com.learnbycoding.springDataJpa.service.StudentService;
...
public class ApplicationMain {
	...
	public static void main(String args[]) {
		 ...
		 * delete a student
		 */
		System.out.println("Deleting student with unique ID :  stud546781");
		...
		System.out.println("Updating student with unique ID :  stud546781"  + " It's roll Number to " + "'13001'");
